    ...
    <div className="flex flex-col gap-6 w-full max-w-lg mx-auto">
      ...
      {!submitted && (
        <button
          ...
          disabled={!selected}
          className="px-6 py-2 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black text-sm font-medium disabled:opacity-30 disabled:cursor-not-allowed hover:bg-zinc-700 dark:hover:bg-zinc-300 transition-colors self-start"
        >
          Check Answer
        </button>
      )}
      ...
      {submitted && (
        <div className="p-4 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
          ...
          <button
            onClick={onNext}
            className="mt-3 px-4 py-2 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black text-sm font-medium hover:bg-zinc-700 dark:hover:bg-zinc-300 transition-colors"
          >
